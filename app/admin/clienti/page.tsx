...
import { Users, Repeat, TrendingUp, Wallet, Search, Loader2, Phone, Package } from "lucide-react";
  ...
  return (
    <div className="animate-in fade-in space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Clienți agregați automat din istoricul de comenzi.</p>
      </div>
                          ...
                          <td colSpan={5} className="px-6 py-4">
                            ...
                            <ul className="space-y-1.5">
                              {[...client.comenzi]
                                ...
                                .map((comanda) => (
                                  <li key={comanda.id} className="text-xs text-gray-600 flex items-center justify-between gap-3">
