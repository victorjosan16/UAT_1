 ...
 * (or scraping) a real logo. `ClubCrest` renders what this returns; when
 * real, licensed artwork is available, only the asset resolver needs to
 * change (e.g. return an image URL keyed by clubId) — nothing in the quiz
 * engine or components reads crest data directly.
 */
...
const SHAPES: readonly CrestShape[] = ["shield", "circle", "hexagon"];
