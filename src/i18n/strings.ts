...
const STRINGS = {
  ...
  "qotd.title": { en: "QUESTION OF THE DAY", ro: "ÎNTREBAREA ZILEI", es: "PREGUNTA DEL DÍA", pt: "PERGUNTA DO DIA", hi: "आज का प्रश्न", id: "PERTANYAAN HARI INI", ru: "ВОПРОС ДНЯ" },
  "qotd.percentCorrect": {
    en: "{percent}% ANSWERED CORRECTLY",
    ro: "{percent}% AU RĂSPUNS CORECT",
    es: "{percent}% RESPONDIÓ CORRECTAMENTE",
    pt: "{percent}% RESPONDERAM CORRETAMENTE",
    hi: "{percent}% ने सही उत्तर दिया",
    id: "{percent}% MENJAWAB DENGAN BENAR",
    ru: "{percent}% ОТВЕТИЛИ ПРАВИЛЬНО",
  },
  "qotd.share": { en: "SHARE QUESTION", ro: "DISTRIBUIE ÎNTREBAREA", es: "COMPARTIR PREGUNTA", pt: "COMPARTILHAR PERGUNTA", hi: "प्रश्न साझा करें", id: "BAGIKAN PERTANYAAN", ru: "ПОДЕЛИТЬСЯ ВОПРОСОМ" },
  "qotd.shareCta": {
    en: "Can you answer it?",
    ro: "Poți răspunde?",
    es: "¿Puedes responderla?",
    pt: "Você consegue responder?",
    hi: "क्या आप इसका उत्तर दे सकते हैं?",
    id: "Bisakah kamu menjawabnya?",
    ru: "Сможешь ответить?",
  },
  "qotd.homeTitle": { en: "Question of the Day", ro: "Întrebarea Zilei", es: "Pregunta del Día", pt: "Pergunta do Dia", hi: "आज का प्रश्न", id: "Pertanyaan Hari Ini", ru: "Вопрос дня" },
  "qotd.homeDesc": {
    en: "One question, everyone answers the same.",
    ro: "O întrebare, toată lumea răspunde la aceeași.",
    es: "Una pregunta, todos responden la misma.",
    pt: "Uma pergunta, todos respondem a mesma.",
    hi: "एक प्रश्न, सभी एक ही का उत्तर देते हैं।",
    id: "Satu pertanyaan, semua orang menjawab yang sama.",
    ru: "Один вопрос, все отвечают на один и тот же.",
  },
